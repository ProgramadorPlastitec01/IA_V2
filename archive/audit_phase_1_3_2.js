...
async function runAudit() {
    console.log("🚀 INICIANDO AUDITORÍA RAG FASE 1.3.2\n");
    await fs.mkdir(REPORTS_DIR, { recursive: true });

    let mdReport = `# Reporte de Upgrade de Embeddings (Fase 1.3.2)\n\n`;
    ...
    const reportPath = path.join(REPORTS_DIR, 'embedding_upgrade_phase_1_3_2.md');
